    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('dc', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='dc', to='monserver.DC')),
            ],
        ),
        migrations.CreateModel(
            name='Service',
        ...
        migrations.AddField(
            model_name='status',
            name='version',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='version', to='monserver.Version'),
        ),
    ]
